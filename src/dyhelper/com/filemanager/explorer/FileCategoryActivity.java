...
import dyhelper.com.filemanager.explorer.FavoriteDatabaseHelper.FavoriteDatabaseListener;
import dyhelper.com.filemanager.explorer.FileCategoryHelper.CategoryInfo;
import dyhelper.com.filemanager.explorer.FileCategoryHelper.FileCategory;
import dyhelper.com.filemanager.explorer.FileManagerMain.IBackPressedListener;
import dyhelper.com.filemanager.explorer.FileViewInteractionHub.Mode;
import dyhelper.com.filemanager.explorer.Util.SDCardInfo;
...
public class FileCategoryActivity extends Fragment implements IFileInteractionListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFileViewActivity = (FileViewActivity) ((FileManagerMain) mActivity)
                .getFragment(Util.SDCARD_TAB_INDEX);
        mRootView = inflater.inflate(R.layout.filemanager_file_explorer_category, container, false);
    ...
    private void setupCategoryInfo() {
        ...
        int[] imgs = new int[] {
                R.drawable.filemanager_category_bar_music, R.drawable.filemanager_category_bar_video,
                R.drawable.filemanager_category_bar_picture, R.drawable.filemanager_category_bar_theme,
                R.drawable.filemanager_category_bar_document, R.drawable.filemanager_category_bar_zip,
                R.drawable.filemanager_category_bar_apk, R.drawable.filemanager_category_bar_other
        };
    ...
    public void refreshCategoryInfo() {
        ...
        if (sdCardInfo != null) {
            ...
            setTextView(R.id.sd_card_capacity, getString(R.string.filemanager_sd_card_size, Util.convertStorage(sdCardInfo.total)));
            setTextView(R.id.sd_card_available, getString(R.string.filemanager_sd_card_available, Util.convertStorage(sdCardInfo.free)));
        }
        ...
        switch (p) {
            case Home:
                ...
                if (mConfigurationChanged) {
                    ((FileManagerMain) mActivity).reInstantiateCategoryTab();
    ...
    public void onDataChanged() {
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
            	Log.i("chaochao", "fileCategoryDataChanged");
    ...
    public String getDisplayPath(String path) {
        return getString(R.string.filemanager_tab_category) + path;
    }
    ...
    private void setCategorySize(FileCategory fc, long size) {
        ...
        switch (fc) {
            case Music:
                ...
                resId = R.string.filemanager_category_music;
                break;
            case Video:
                txtId = R.id.category_legend_video;
                resId = R.string.filemanager_category_video;
                break;
            case Picture:
                txtId = R.id.category_legend_picture;
                resId = R.string.filemanager_category_picture;
                break;
            case Theme:
                txtId = R.id.category_legend_theme;
                resId = R.string.filemanager_category_theme;
                break;
            case Doc:
                txtId = R.id.category_legend_document;
                resId = R.string.filemanager_category_document;
                break;
            case Zip:
                txtId = R.id.category_legend_zip;
                resId = R.string.filemanager_category_zip;
                break;
            case Apk:
                txtId = R.id.category_legend_apk;
                resId = R.string.filemanager_category_apk;
                break;
            case Other:
                txtId = R.id.category_legend_other;
                resId = R.string.filemanager_category_other;
                break;
        }
    ...
    private void updateUI() {
        ...
        Log.i("chaochao", "----updateUI-----" + sdCardReady);
