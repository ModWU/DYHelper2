...
import dyhelper.com.filemanager.explorer.FileIconLoader.IconLoadFinishListener;
...
public class FileIconHelper implements IconLoadFinishListener {
    ...
    static {
        addItem(new String[] {
            "mp3"
        }, R.drawable.filemanager_file_icon_mp3);
        addItem(new String[] {
            "wma"
        }, R.drawable.filemanager_file_icon_wma);
        addItem(new String[] {
            "wav"
        }, R.drawable.filemanager_file_icon_wav);
        addItem(new String[] {
            "mid"
        }, R.drawable.filemanager_file_icon_mid);
        addItem(new String[] {
                "mp4", "wmv", "mpeg", "m4v", "3gp", "3gpp", "3g2", "3gpp2", "asf"
        }, R.drawable.filemanager_file_icon_video);
        addItem(new String[] {
                "jpg", "jpeg", "gif", "png", "bmp", "wbmp"
        }, R.drawable.filemanager_file_icon_picture);
        addItem(new String[] {
                "txt", "log", "xml", "ini", "lrc"
        }, R.drawable.filemanager_file_icon_txt);
        addItem(new String[] {
                "doc", "ppt", "docx", "pptx", "xsl", "xslx",
        }, R.drawable.filemanager_file_icon_office);
        addItem(new String[] {
            "pdf"
        }, R.drawable.filemanager_file_icon_pdf);
        addItem(new String[] {
            "zip"
        }, R.drawable.filemanager_file_icon_zip);
        addItem(new String[] {
            "mtz"
        }, R.drawable.filemanager_file_icon_theme);
        addItem(new String[] {
            "rar"
        }, R.drawable.filemanager_file_icon_rar);
    }
    ...
    public static int getFileIcon(String ext) {
        ...
        if (i != null) {
            ...
            return R.drawable.filemanager_file_icon_default;
        }
    ...
    public void setIcon(FileInfo fileInfo, ImageView fileImage, ImageView fileImageFrame) {
        ...
        switch (fc) {
            ...
            case Video:
                ...
                if (set)
                    ...
                    fileImage.setImageResource(fc == FileCategory.Picture ? R.drawable.filemanager_file_icon_picture
                            : R.drawable.filemanager_file_icon_video);
        ...
        if (!set)
            fileImage.setImageResource(R.drawable.filemanager_file_icon_default);
    }
