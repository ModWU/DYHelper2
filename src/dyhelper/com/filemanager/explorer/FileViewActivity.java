...
public class FileViewActivity extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRootView = inflater.inflate(R.layout.filemanager_file_explorer_list, container, false);
        ...
        mAdapter = new FileListAdapter(mActivity, R.layout.filemanager_file_browser_item, mFileNameList, mFileViewInteractionHub,
                mFileIconHelper);
    ...
    public void onDataChanged() {
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
            	Log.i("chaochao", "FileViewDataChanged");
    ...
    public String getDisplayPath(String path) {
        if (path.startsWith(this.sdDir) && !FileExplorerPreferenceActivity.showRealPath(mActivity)) {
            return getString(R.string.filemanager_sd_folder) + path.substring(this.sdDir.length());
        } else {
            return path;
        }
    }
    ...
    public String getRealPath(String displayPath) {
        final String perfixName = getString(R.string.filemanager_sd_folder);
