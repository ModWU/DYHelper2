...
import dyhelper.com.filemanager.explorer.MediaFile.MediaFileType;
...
public class FileCategoryHelper {
    ...
    static {
        categoryNames.put(FileCategory.All, R.string.filemanager_category_all);
        categoryNames.put(FileCategory.Music, R.string.filemanager_category_music);
        categoryNames.put(FileCategory.Video, R.string.filemanager_category_video);
        categoryNames.put(FileCategory.Picture, R.string.filemanager_category_picture);
        categoryNames.put(FileCategory.Theme, R.string.filemanager_category_theme);
        categoryNames.put(FileCategory.Doc, R.string.filemanager_category_document);
        categoryNames.put(FileCategory.Zip, R.string.filemanager_category_zip);
        categoryNames.put(FileCategory.Apk, R.string.filemanager_category_apk);
        categoryNames.put(FileCategory.Other, R.string.filemanager_category_other);
        categoryNames.put(FileCategory.Favorite, R.string.filemanager_category_favorite);
    }
