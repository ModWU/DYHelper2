...
public class FileManagerMain extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.filemanager_fragment_pager);
        ...
        View localView = getLayoutInflater().inflate(R.layout.filemanage_custom_layout, null);
        bar.setCustomView(localView);
        localView.findViewById(R.id.id_back).setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
            FileManagerMain.this.onBackPressed();
          }
        });
        
        mTabsAdapter = new TabsAdapter(this, mViewPager);
        mTabsAdapter.addTab(bar.newTab().setText(R.string.filemanager_tab_category),
                FileCategoryActivity.class, null);
        mTabsAdapter.addTab(bar.newTab().setText(R.string.filemanager_tab_sd),
                FileViewActivity.class, null);
        mTabsAdapter.addTab(bar.newTab().setText(R.string.filemanager_tab_remote),
    ...
    public static class TabsAdapter extends FragmentPagerAdapter
		...
		public void onTabSelected(Tab tab, android.app.FragmentTransaction ft) {
            ...
            if(!tab.getText().equals(mContext.getString(R.string.filemanager_tab_sd))) {
