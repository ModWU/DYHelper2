...
import dyhelper.com.filemanager.swiftp.ProxyConnector;
import dyhelper.com.filemanager.swiftp.SessionThread;
import dyhelper.com.filemanager.swiftp.TcpListener;
...
public class FTPServerService extends Service implements Runnable {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        while (serverThread != null) {
            ...
            if (attempts > 0) {
                attempts--;
                dyhelper.com.filemanager.swiftp.Util.sleepIgnoreInterupt(1000);
            } else {
    ...
    private void setupNotification() {
        ...
        int icon = R.drawable.filemanager_notification;
        CharSequence tickerText = getString(R.string.filemanager_notif_server_starting);
        long when = System.currentTimeMillis();
        CharSequence contentTitle = getString(R.string.filemanager_notif_title);
        ...
        Intent notificationIntent = new Intent(this, FileManagerMain.class);
    ...
    public static InetAddress getWifiIp() {
        ...
        if (isWifiEnabled()) {
            ...
            if (ipAsInt == 0) {
                ...
                return dyhelper.com.filemanager.swiftp.Util.intToInet(ipAsInt);
            }
        } else {
            return null;
        }
