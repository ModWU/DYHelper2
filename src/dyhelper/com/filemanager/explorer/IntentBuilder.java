...
public class IntentBuilder {
    ...
    public static void viewFile(final Context context, final String filePath) {
        ...
        if (!TextUtils.isEmpty(type) && !TextUtils.equals(type, "*/*")) {
            ...
            dialogBuilder.setTitle(R.string.filemanager_dialog_select_type);

            CharSequence[] menuItemArray = new CharSequence[] {
                    context.getString(R.string.filemanager_dialog_type_text),
                    context.getString(R.string.filemanager_dialog_type_audio),
                    context.getString(R.string.filemanager_dialog_type_video),
                    context.getString(R.string.filemanager_dialog_type_image) };
